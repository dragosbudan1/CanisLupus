...
WORKDIR /app
COPY ./CanisLupus.Common/ ./CanisLupus.Common/
COPY ./CanisLupus.Web/ ./CanisLupus.Web/

# Install dependencies. 
# https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-restore?tabs=netcore2x
RUN dotnet restore "./CanisLupus.Web/CanisLupus.Web.csproj"

# Compile, then pack the compiled app and dependencies into a deployable unit.
# https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-publish?tabs=netcore21
RUN dotnet publish "./CanisLupus.Web/CanisLupus.Web.csproj" -c Release -o /app/publish
